...
public class FragmentResultsList extends Fragment implements AdminTestViewAdapter.OnTestClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onTestClick(CardView view, int position) {
        new FetchTest(getActivity(), ResultsActivity.class, getArguments().getString("login"), getArguments().getString("password"), view, testList.get(position).getTestID()).execute();
    }
