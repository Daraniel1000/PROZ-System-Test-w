...
public class TestViewAdapter extends RecyclerView.Adapter<TestViewAdapter.MyViewHolder> {
    ...
    private ArrayList<prozTest> prozTestArrayList;

    public TestViewAdapter(Context ctx, ArrayList<prozTest> prozTestArrayList, OnTestClickListener onTestClickListener){
    ...
    public void onBindViewHolder(TestViewAdapter.MyViewHolder holder, int position) {
        ...
        holder.tvQAmount.setText(""+prozTestArrayList.get(position).getQuestionsSize());
    }
