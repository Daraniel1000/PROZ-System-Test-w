...
public class AdminResultsViewAdapter extends RecyclerView.Adapter<AdminResultsViewAdapter.MyViewHolder> {
    ...
    private List<prozResults> results = new ArrayList<>();


    public AdminResultsViewAdapter(Context ctx) {
    ...
    @Override
    public void onBindViewHolder(AdminResultsViewAdapter.MyViewHolder holder, int position) {
    ...
    public void setResultsList(List<prozResults> results) {
